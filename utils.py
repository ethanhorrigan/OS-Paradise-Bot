...
# Returns an ordinal number (e.g. 1 = 1st, 2 = 2nd etc)
...
def date_suffixes(day):
    if str(day).endswith('0') or day > 4 and day < 21:
        return 'th'
    elif day == 1 or str(day).endswith('1'):
        return 'st'
    elif day == 2 or str(day).endswith('2'):
        return 'nd'
    elif day == 3 or str(day).endswith('3'):
        return 'rd'
    else:
        return None
