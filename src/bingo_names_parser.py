...
#             ehb = response['ehb'] * 0.9
#             # ehb = round(ehb)
#             ehp = response['ehp'] * 0.1
#             country = response['country']
#             build_type = response['type']
#             average = ehb + ehp
#             average = round(average)
#             print(
#                 f'{username} average: {average} country: {country} type: {build_type}')
...
# newlist = sorted(players, key=itemgetter('average'), reverse=True)
